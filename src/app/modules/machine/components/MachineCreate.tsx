...
const MachineCreate: React.FC = () => {
    ...
    const validate = (data: typeof formData): FormErrors => {
        ...
        const mfrErr = validateRequired(data.manufacturer, 'ผู้ผลิต / ยี่ห้อ');
        if (mfrErr) errs.manufacturer = mfrErr;
    ...
    const selectClass = (fieldName: string) => {
        if (!touched[fieldName]) return 'form-select form-select-lg';
        return 'form-select form-select-lg is-valid';
    };
