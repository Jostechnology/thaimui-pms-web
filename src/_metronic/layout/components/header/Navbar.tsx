...
const Navbar = () => {
  ...
  const [employeeName, setEmployeeName] = useState<string | null>(getUsernameLocal())
            ...
            <ul className={`dropdown-menu mr-5 ${isDropdownOpen ? 'show' : ''}`}>
              <li>
                <div className="user-info-section">
                  <div className="mb-2">
                    <div className="user-info-label">สาขา</div>
                    <div className="user-info-value">{branchName}</div>
                  </div>
                  <div>
                    <div className="user-info-label">ชื่อ</div>
                    <div className="user-info-value">{employeeName ?? "error"}</div>
                  </div>
                </div>
              </li>
